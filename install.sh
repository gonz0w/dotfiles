...
sudo yum install ccze jq unzip python-pip wget etags-ctags figlet vim lsof htop bash-completion telnet nc strace psmisc iotop sysstat tcpdump bind-utils nodejs npm jq -y
